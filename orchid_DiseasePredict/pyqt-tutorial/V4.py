...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox2.setGeometry(QtCore.QRect(670, 10, 69, 22))
        self.comboBox2.setObjectName("comboBox2")
        self.label2 = QtWidgets.QLabel(self.centralwidget)
        self.label2.setGeometry(QtCore.QRect(610, 10, 81, 21))
        self.label2.setObjectName("label2")
        self.checkBox1 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox1.setGeometry(QtCore.QRect(790, 10, 121, 16))
        ...
        self.checkBox2.setGeometry(QtCore.QRect(790, 30, 121, 16))
        self.checkBox2.setObjectName("checkBox2")
        self.checkBox3 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox3.setGeometry(QtCore.QRect(790, 50, 121, 16))
        ...
        self.voltage_meter.setGeometry(QtCore.QRect(610, 40, 131, 20))
        self.voltage_meter.setObjectName("voltage_meter")
        self.update_time = QtWidgets.QLabel(self.centralwidget)
        self.update_time.setGeometry(QtCore.QRect(1090, 40, 221, 31))
