...
# build the RNN model
def simpleNN(allow_cudnn_kernel=True):
    simpleNN = Sequential()
    simpleNN.add(Flatten(input_shape=(timesteps, num_input)))
    simpleNN.add(Dense(128, activation='relu'))
    simpleNN.add(Dense(64, activation='relu'))
    simpleNN.add(Dense(32, activation='relu'))
    # simpleNN.add(Dense(32, activation='relu'))
    # simpleNN.add(Dense(32, activation='relu'))
    simpleNN.add(Dense(num_class, activation='relu'))
    simpleNN.summary()
    return simpleNN
